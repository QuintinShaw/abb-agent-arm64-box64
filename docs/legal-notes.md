...
This project is not affiliated with Synology Inc. and is not officially
...
Generated deb packages in `dist/` contain Synology proprietary files and should
not be uploaded to GitHub, published as releases, or redistributed.
